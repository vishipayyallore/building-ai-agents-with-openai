...
| Session scripts (live) | `presentation/demo-0N/` (transitional) |
| Session course packages | `sessions/session-NN-*/` |
| Architecture diagrams | `docs/architecture/`, exported PNGs in `assets/` |
...
All converters write **staging artifacts**. Promote content into `docs/`, `sessions/session-NN-*/`, or `presentation/demo-0N/` manually after synthesis.
