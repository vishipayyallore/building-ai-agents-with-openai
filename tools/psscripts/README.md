...
Batch-converts **PDF**, **HTML**, **PPTX**, and **Word (DOCX/DOC)** under `source-material/` to colocated `.md` staging files. Synthesize results into `docs/`, `sessions/session-NN-*/`, and `presentation/demo-0N/` — see [tools/pyscripts/README.md](../pyscripts/README.md) (workflow + migration target map).
