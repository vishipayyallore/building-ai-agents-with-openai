...
| `02_educational-content-rules.mdc` | Educational content expectations | globs: `*` |
| `03_repository-structure.mdc` | Canonical paths | globs: `*` |
| `04_quality-assurance.mdc` | Local QA command set | globs: `*` |
| `05_markdown-standards.mdc` | Markdown conventions | globs: `*` |
| `06_primary-directives.mdc` | Minimal/targeted edit directives | globs: `*` |
| `07_source_material_rules.mdc` | Do not assume reference-material folders | globs: `*` |
